...
#TypePlot = "S2"
# TypePlot            = "GFACTOR"
# Comparision of "Broken Path ensemble" and "Swap+Unswap grand ensemble" methodologies
#TypePlot = "COMBINE"
...
if TypeCal == "ENT" and TypePlot == "S2":
    ...
    if variableName == "beta":
        ...
        parameter = tau
        print("TAPAS")
        FigureGenerator.GetFigureEntropyRT_vs_beta(
            TypeCal,
            molecule_rot,
            TransMove,
            RotMove,
    ...
    if variableName == "tau":
        ...
        FigureGenerator.GetFigureEntropyRT_vs_tau(
            TypeCal,
            molecule_rot,
            TransMove,
            RotMove,
...
if TypeCal == "ENT" and TypePlot == "COMPARE":
    ...
    if numbmolecules < 4:
        ...
        exit()
    ENT_TYPE = "SWAPTOUNSWAP"
    FigureGenerator.GetFigureEntropyRT_vs_gFactor_COMPARE(
        TypeCal,
        ENT_TYPE,
        molecule_rot,
        TransMove,
...
if (TypePlot == "Energy"):
	...
	FigureGenerator.FigureEnergyPIGS(
		TypeCal,
        molecule_rot,
        TransMove,
        RotMove,
